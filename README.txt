...
After all fields are picked correctly, click download. The program will download the content to your downloads folder, in a subdirectory named the same as the domain name of the site you're downloading from.
